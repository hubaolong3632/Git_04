...
public class SendMail {
    ...
    public static String myEmailAccount = "911412667@qq.com";
    public static String myEmailPassword = "iiljcvxpderebcci";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "911412667@qq.com";
